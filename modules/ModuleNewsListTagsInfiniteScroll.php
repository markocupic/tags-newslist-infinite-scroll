...
/**
 * Contao News List Tags Infinite Scroll
 *
...
/**
 * Class ModuleNewsListTagsInfiniteScroll
 * @package Markocupic
 */
class ModuleNewsListTagsInfiniteScroll extends ModuleNewslistInfiniteScroll
{
    /**
    ...
    public function generate()
    {
        ...
        /** Hack Marko Cupic **/
        // Overwrite label
        $GLOBALS['TL_LANG']['FMD']['contao_news_infinite_scroll'] = $GLOBALS['TL_LANG']['FMD']['newslist_tags_infinite_scroll'];
